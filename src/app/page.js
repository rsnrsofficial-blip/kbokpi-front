...
export default function Home() {
  ...
  return (
    <main style={{minHeight:'100vh',background:'#f5f5f0',display:'flex',flexDirection:'column',alignItems:'center',padding:'40px 20px'}}>
      <div style={{width:'100%',maxWidth:600}}>
        <div style={{textAlign:'center',marginBottom:32}}>
          ...
          <p style={{fontSize:'clamp(12px,3vw,14px)',color:'#666'}}>연봉 대비 성과를 AI가 냉정하게 평가합니다</p>
        </div>
